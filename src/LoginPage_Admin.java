...
public class LoginPage_Admin extends javax.swing.JFrame {
    ...
    private void jLabelCreateAccountMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelCreateAccountMouseClicked
        ...
        RegistrationForm_Admin arf= new RegistrationForm_Admin();
        arf.setVisible(true);
        arf.pack();
    ...
    private void jLabelForgotPasswordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelForgotPasswordMouseClicked
        // Jump to Forgot Password Page
            ...
            ForgotPassword_Admin afp= new ForgotPassword_Admin();
            afp.setVisible(true);
            afp.pack();
            afp.setLocationRelativeTo(null);
            afp.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
