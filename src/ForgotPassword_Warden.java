 ...
 * @author J$
 */
public class ForgotPassword_Warden extends javax.swing.JFrame {

    /**
     * Creates new form wardenForgotPassword
     */
    public ForgotPassword_Warden() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButtonClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 10, 60, -1));
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        ...
        try
        {
            ...
            ResultSet rs = st.executeQuery("SELECT securityQ FROM warden WHERE username = '"+username+"'");
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        try
        {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM warden WHERE username = '"+username+"' AND answer = '"+answer+"'");

            if(rs.next())
            {
                st.executeUpdate("UPDATE warden SET password = '"+newPassword+"' WHERE username = '"+username+"' AND answer = '"+answer+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ForgotPassword_Warden.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ForgotPassword_Warden().setVisible(true);
            }
        });
    }
